...
export const PaginationPrevious = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
export const PaginationNext = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
